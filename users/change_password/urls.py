...
urlpatterns = [
    ...
    # method - otp
    # create otp model
    path('create/otp/', views.ChangeOTPCreateView.as_view(), name='change-create-otp'),
    # send a mail with an otp
    path('send-mail/otp/', views.ChangeSendOTPMail.as_view(), name='change-send-otp-mail'),
    # verify otp
    path('verify-otp/', views.ChangeVerifyOTPView.as_view(), name='change-verify-otp'),
